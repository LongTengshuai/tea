...
h = figure;
set(h,'position',[250 150 1020 550]);
subplot(2,2,1)
...
box off
legend('\fontname{Arial}HB','\fontname{Arial}BY','\fontname{Arial}FH','Location','NorthWest');
...
plot(XR*ones(size(YL)),YL,'color','k','LineWidth',1)
box off
legend('\fontname{Arial}HB','\fontname{Arial}BY','\fontname{Arial}FH','Location','southwest');
...
set(gca,'FontSize',12,'Fontname', 'Arial','LineWidth',1);
set(gca,'tickdir','out');
text(540,-0.012,str1,'FontSize',12);
text(725,-0.012,str2,'FontSize',12)
XL = get(gca,'xlim'); XR = XL(2);
YL = get(gca,'ylim'); YT = YL(2);
plot(XL,YT*ones(size(XL)),'color','k','LineWidth',1)
plot(XR*ones(size(YL)),YL,'color','k','LineWidth',1)
box off
legend('\fontname{Arial}HB','\fontname{Arial}BY','\fontname{Arial}FH','\fontname{Arial}Spectral interval','Location','NorthWest');
...
xlabel({'\fontname{Arial}Wavelength (nm)'},'FontSize',11,'LineWidth',1);
ylabel({'\fontname{Arial}Reflectivity'},'FontSize',11,'LineWidth',1);
axis([900,1700,-0.03,0.01]);
set(gca,'FontSize',12,'Fontname', 'Arial','LineWidth',1);
set(gca,'tickdir','out');
text(1140,0.005,str3,'FontSize',12);
text(1370,0.005,str4,'FontSize',12)
XL = get(gca,'xlim'); XR = XL(2);
YL = get(gca,'ylim'); YT = YL(2);
plot(XL,YT*ones(size(XL)),'color','k','LineWidth',1)
plot(XR*ones(size(YL)),YL,'color','k','LineWidth',1)
box off
legend('\fontname{Arial}HB','\fontname{Arial}BY','\fontname{Arial}FH','\fontname{Arial}Spectral interval','Location','southwest');
